...
describe('FlipList Controllers', function() {
  ...
  beforeEach(function() {
    ...
    testLists = [
      {id:1, user_id:1, title:'List1', items:[{id:1, name:'Item 1', sort_order: 0, list_id:1}, {id:2, name:'Item2', sort_order: 1, list_id:1}]},
      {id:2, user_id:1, title:'Empty List'}
      ];
    testList = testLists[0];

  });

  describe('FlipListListsController', function() {

    beforeEach(inject(function($rootScope, $controller) {
      routeParams = {}; //passed in to controller so we can modify in tests
      routeParams.userId = testUser.id;

      $httpBackend.expectGET('api/users/' + routeParams.userId + '/lists').
        respond(testLists);

      scope = $rootScope.$new();
      controller = $controller('FlipListListsController', {$scope: scope, $routeParams: routeParams});
    ...
    it('should create a list', function() {
      ...
      $httpBackend.expectPOST('api/users/' + routeParams.userId + '/lists', newList).respond(200);
    ...
    it('should delete a list', function() {
      ...
      $httpBackend.expectDELETE('api/users/' + routeParams.userId + '/lists/' + testList.id).respond(200);
  ...
  describe('FlipListListDetailController', function() {

    beforeEach(inject(function($rootScope, $controller) {
      routeParams = {}; //passed in to controller so we can modify in tests
      routeParams.userId = testList.user_id;
      routeParams.listId = testList.id;
      $httpBackend.expectGET('api/users/' + routeParams.userId + '/lists/' + routeParams.listId).
        respond(testList);
      
      scope = $rootScope.$new();
      controller = $controller('FlipListListDetailController', {$scope: scope, $routeParams: routeParams});
    ...
    it('should update a list', function() {
      ...
      $httpBackend.expectPUT('api/users/' + routeParams.userId + '/lists/' + routeParams.listId, testList).respond(200);
  ...
  describe('FlipListItemsController', function() {
    ...
    beforeEach(inject(function($rootScope, $controller) {
      ...
      $httpBackend.expectGET('api/users/' + routeParams.userId + '/lists/' + routeParams.listId).
        respond(testList);
      $httpBackend.expectGET('api/users/' + routeParams.userId + '/lists/' + routeParams.listId + '/items').
      ...
      detailController = $controller('FlipListListDetailController', {$scope: scope, $routeParams: routeParams});
    ...
    it('should create an item', function() {
      ...
      $httpBackend.expectPOST('api/users/' + routeParams.userId + '/lists/' + routeParams.listId + '/items', newItem).respond(200);
    ...
    it('should update an item', function() {
      ...
      $httpBackend.expectPUT('api/users/' + routeParams.userId + '/lists/' + routeParams.listId + '/items/' + testItem.id, testItem).respond(200);
    ...
    it('should delete an item', function() {
      ...
      $httpBackend.expectDELETE('api/users/' + routeParams.userId + '/lists/' + routeParams.listId + '/items/' + testItem.id).respond(200);
      $httpBackend.expectPATCH('api/users/' + routeParams.userId + '/lists/' + routeParams.listId + '/sort').respond(200);
    ...
    it('should not order items if no sort orders have changed', function() {
      ...
      //delete last item
      $httpBackend.expectDELETE('api/users/' + routeParams.userId + '/lists/' + routeParams.listId + '/items/' + lastItem.id).respond(200);
